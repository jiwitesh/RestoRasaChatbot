# -*- coding: utf-8 -*-
"""
Created on Wed May 22 03:09:26 2019
...
class ActionValidateLocation(Action):
	...
	def run(self, dispatcher, tracker, domain):
		list_loc = ["ahmedabad","bangalore", "bengaluru","chennai","delhi","hyderabad","kolkata","mumbai","pune","agra","ajmer","aligarh","allahabad","amravati","amritsar",
        ...
        #print("Location extracted == ", tracker.get_slot('location'))
...
class ActionValidateCuisine(Action):
	...
	def run(self, dispatcher, tracker, domain):
        ...
        #print("Cuisine extracted == ", cuisine)
		if cuisine is not None:
			if cuisine.lower() in list_cuisine:
                #print("Cuisine found == ", cuisine)
...
class ActionSearchRestaurants(Action):
	...
	def run(self, dispatcher, tracker, domain):
		config={ "user_key":"a07a8055e35991018a53ee01ff144b8b"}#type your zomato API key here
        ...
        #print("values extracted", loc, cuisine, budget)
...
class ActionSendEmail(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		gmail_user = 'jiwitesh05nov@gmail.com'  #typr your email id here
		gmail_password = 'jiwihonourable' #typr your password here
